<div>
    <img wire:click="VerForm()" title="Editar" src="{{ asset('imgs/img_sistema/editar.png') }}" alt="Editar" class="cursor-pointer h-[1.5rem] w-[1.5rem]" />
    ...
    <div class="ventanaInterna_1">
        <img src="{{ asset('imgs/img_sistema/cancelar.png' ) }}" 
            ...
            <span class="text-2xl mb-3">EDITANDO DATOS</span>
